...
import 'package:trainer/view/member_main_view.dart';
  ...
  static final routes = [
    ...
    GetPage(
      ...
      binding: BindingsBuilder(() {
        ...
        // Get.put(MemberPlayStatusController(memberPlayStatusService: injector.get<MemberPlayStatusService>()));
        // Get.put(BluetoothController(memberPlayStatusService: injector.get<MemberPlayStatusService>()));
        Get.put(MemberAllController(memberPlayStatusService: injector.get<MemberPlayStatusService>()));
